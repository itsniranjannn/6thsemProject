...
// Cache transporter to avoid multiple connections
...
// Test email configuration - FIXED: Don't create new transporter
...
// Enhanced email sending - FIXED: Don't call testEmailConfig inside sendEmail
const sendEmail = async (mailOptions) => {
  try {
    ...
    // Reset transporter on auth error
    if (error.code === 'EAUTH') {
      console.error('❌ Authentication failed - resetting transporter');
      transporter = null;
    }
      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            ...
            <div class="success">
              <strong>📦 Shipping Update:</strong> Your package has been handed over to our delivery partner.
            </div>
        ...
        <div class="container">
          ...
          <div class="content">
            ...
            ${order.payment_status === 'completed' ? `
              <div class="success">
                <strong>💰 Refund Initiated:</strong> Your payment will be refunded within 5-7 business days.
              </div>
            ` : ''}
      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            ...
            <div class="success">
              <strong>✅ Account Verified:</strong> You now have full access to all Nexus Store features.
            </div>
