...
const AdminDashboard = () => {
  ...
  // Product form state with multiple images
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <div className="card bg-gradient-to-br from-blue-500 to-blue-600 text-white transform hover:scale-105 transition-transform duration-300 shadow-xl">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-blue-100 text-sm font-medium">Total Revenue</p>
                <p className="text-2xl font-bold">{formatNPR(stats.totalRevenue)}</p>
              </div>
              <div className="w-12 h-12 bg-blue-400/20 rounded-xl flex items-center justify-center backdrop-blur-sm">
          ...
          <div className="card bg-gradient-to-br from-green-500 to-emerald-600 text-white transform hover:scale-105 transition-transform duration-300 shadow-xl">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-green-100 text-sm font-medium">Total Orders</p>
                <p className="text-2xl font-bold">{stats.totalOrders}</p>
              </div>
              <div className="w-12 h-12 bg-green-400/20 rounded-xl flex items-center justify-center backdrop-blur-sm">
                <span className="text-2xl">📦</span>
              </div>
            </div>
          ...
          <div className="card bg-gradient-to-br from-purple-500 to-purple-600 text-white transform hover:scale-105 transition-transform duration-300 shadow-xl">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-purple-100 text-sm font-medium">Total Products</p>
                <p className="text-2xl font-bold">{stats.totalProducts}</p>
              </div>
              <div className="w-12 h-12 bg-purple-400/20 rounded-xl flex items-center justify-center backdrop-blur-sm">
          ...
          <div className="card bg-gradient-to-br from-orange-500 to-orange-600 text-white transform hover:scale-105 transition-transform duration-300 shadow-xl">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-orange-100 text-sm font-medium">Total Users</p>
                <p className="text-2xl font-bold">{stats.totalUsers}</p>
              </div>
              <div className="w-12 h-12 bg-orange-400/20 rounded-xl flex items-center justify-center backdrop-blur-sm">
                <span className="text-2xl">👥</span>
              </div>
            </div>
        ...
        {/* Main Content */}
        <div className="card bg-white/80 backdrop-blur-sm border border-white/20 shadow-xl">
          {/* Tabs */}
            ...
            <nav className="-mb-px flex space-x-8">
              {tabs.map(tab => (
                <button
                  ...
                  className={`whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm flex items-center space-x-2 transition-all duration-300 ${
                    activeTab === tab.id
          ...
          <div className="mt-6">
            {loading ? (
              ...
              <>
                {activeTab === 'overview' && <OverviewTab products={products} orders={orders} users={users} formatNPR={formatNPR} getStatusColor={getStatusColor} />}
                {activeTab === 'products' && <ProductsTab products={products} onEdit={openEditModal} onDelete={handleDeleteProduct} onAdd={openAddModal} formatNPR={formatNPR} />}
                {activeTab === 'orders' && <OrdersTab orders={orders} users={users} formatNPR={formatNPR} getStatusColor={getStatusColor} onViewDetails={openOrderDetails} onUpdateStatus={handleUpdateOrderStatus} />}
                {activeTab === 'users' && <UsersTab users={users} onDelete={handleDeleteUser} />}
                {activeTab === 'analytics' && <AnalyticsTab stats={stats} orders={orders} formatNPR={formatNPR} />}
              </>
            )}
          </div>
        </div>
...
const OverviewTab = ({ products, orders, users, formatNPR, getStatusColor }) => {
        ...
        <div>
          ...
          <div className="space-y-3">
            {recentOrders.map(order => (
              <div key={order.id} className="flex items-center justify-between p-4 border border-gray-200 rounded-xl hover:bg-gray-50 transition-all duration-300 transform hover:scale-105">
                <div>
                  <p className="font-medium text-gray-900">Order #{order.id}</p>
                  <p className="text-sm text-gray-500">{order.user_name || 'Customer'}</p>
                </div>
                <div className="text-right">
                  <p className="font-semibold text-gray-900">{formatNPR(order.total_amount)}</p>
        ...
        <div>
          ...
          <div className="space-y-3">
            {lowStockProducts.slice(0, 5).map(product => (
              <div key={product.id} className="flex items-center justify-between p-4 border border-red-200 rounded-xl bg-red-50 hover:bg-red-100 transition-colors">
                <div className="flex items-center space-x-3">
                  <img className="w-12 h-12 rounded-xl object-cover border border-red-200" src={product.image_urls?.[0] || product.image_url} alt={product.name} />
                  <div>
      ...
      <div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-4">
          {recentUsers.map(user => (
            <div key={user.id} className="text-center p-4 border border-gray-200 rounded-xl hover:bg-gray-50 transition-all duration-300 transform hover:scale-110">
              <div className="w-12 h-12 bg-gradient-to-br from-blue-500 to-purple-600 rounded-full flex items-center justify-center mx-auto mb-2 shadow-lg">
